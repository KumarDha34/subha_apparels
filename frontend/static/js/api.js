...
const MENU = [
  ...
  // ---- Financial (executive + accounts) ----
  { key: "kpi", label: "Management KPI Dashboard", href: "/dashboard/kpi/", icon: "\u{1F4C8}", roles: ["ADMIN"], adminNav: true, section: "Financial" },
  { key: "admin", label: "Financial Dashboard", href: "/dashboard/admin/", icon: "\u{1F4B0}", roles: ["ADMIN"], adminNav: true, section: "Financial" },
  { key: "report-quotations", label: "Quotations", href: "/accounts/quotations/", icon: "\u{1F4C4}", roles: ["ADMIN"], adminNav: true, section: "Financial" },
  { key: "accounts-customer-invoices", label: "Customer Invoices", href: "/accounts/customer-invoices/", icon: "\u{1F9FE}", roles: ["ADMIN"], adminNav: true, section: "Financial" },
  { key: "accounts-payments", label: "Supplier Bills", href: "/accounts/payments/", icon: "\u{1F4B3}", roles: ["ADMIN"], adminNav: true, section: "Financial" },
  { key: "accounts-party-ledger", label: "Party Ledger", href: "/accounts/party-ledger/", icon: "\u{1F4D2}", roles: ["ADMIN"], adminNav: true, section: "Financial" },
  { key: "accounts-supplier-ledger", label: "Supplier Ledger", href: "/accounts/supplier-ledger/", icon: "\u{1F4D5}", roles: ["ADMIN"], adminNav: true, section: "Financial" },
  { key: "accounts-order-pnl", label: "Order P&L", href: "/accounts/order-pnl/", icon: "\u{1F4CA}", roles: ["ADMIN"], adminNav: true, section: "Financial" },
  { key: "accounts-product-pnl", label: "Product Profitability", href: "/accounts/product-pnl/", icon: "\u{1F4B9}", roles: ["ADMIN"], adminNav: true, section: "Financial" },
  { key: "accounts-operator-payments", label: "Operator Payments", href: "/accounts/operator-payments/", icon: "\u{1F9D1}\u{200D}\u{1F3ED}", roles: ["ADMIN"], adminNav: true, section: "Financial" },
  // ---- Operations ----
  { key: "merch-orders", label: "Orders & Products", href: "/merchandising/orders/", icon: "\u{1F4DD}", roles: ["ADMIN"], adminNav: true, section: "Operations" },
  { key: "cutting-orders-list", label: "Cutting Entry", href: "/cutting/orders/", icon: "\u{2702}\u{FE0F}", roles: ["ADMIN"], adminNav: true, section: "Operations" },
  ...
  { key: "users", label: "Employee Master", href: "/users/", icon: "\u{1F465}", roles: ["ADMIN"], adminNav: true, section: "People & System" },
  { key: "report-activity-log", label: "Activity Log", href: "/reports/?key=activity-log", icon: "\u{1F5C3}\u{FE0F}", roles: ["ADMIN"], adminNav: true, section: "People & System" },
  ...
  { key: "production-alterations", label: "Alterations (Rework)", href: "/production/alterations/", icon: "\u{1F9F5}", roles: ["ADMIN", "PRODUCTION_SUPERVISOR"], section: "Production" },
  ...
  { key: "accounts-payments", label: "Supplier Bills", href: "/accounts/payments/", icon: "\u{1F4B3}", roles: ["ADMIN", "ACCOUNTS"], section: "Accounts" },
  { key: "accounts-party-ledger", label: "Party Ledger", href: "/accounts/party-ledger/", icon: "\u{1F4D2}", roles: ["ADMIN", "ACCOUNTS"], section: "Accounts" },
  { key: "accounts-supplier-ledger", label: "Supplier Ledger", href: "/accounts/supplier-ledger/", icon: "\u{1F4D5}", roles: ["ADMIN", "ACCOUNTS"], section: "Accounts" },
  { key: "accounts-order-pnl", label: "Order P&L", href: "/accounts/order-pnl/", icon: "\u{1F4CA}", roles: ["ADMIN", "ACCOUNTS"], section: "Accounts" },
  { key: "accounts-product-pnl", label: "Product Profitability", href: "/accounts/product-pnl/", icon: "\u{1F4C8}", roles: ["ADMIN", "ACCOUNTS"], section: "Accounts" },
