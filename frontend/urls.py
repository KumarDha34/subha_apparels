...
urlpatterns = [
    ...
    path("accounts/party-ledger/", views.page_view, {"page": "accounts_party_ledger"}, name="accounts-party-ledger"),
    path("accounts/supplier-ledger/", views.page_view, {"page": "accounts_supplier_ledger"}, name="accounts-supplier-ledger"),
    path("accounts/product-pnl/", views.page_view, {"page": "accounts_product_pnl"}, name="accounts-product-pnl"),
    ...
    path("production/alterations/", views.page_view, {"page": "production_alterations"}, name="production-alterations"),
